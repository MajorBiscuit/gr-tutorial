...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.tutorial_qpsk_demod_cpp_cb_0, 0))    
        ...
        self.connect((self.tutorial_qpsk_demod_cpp_cb_0, 0), (self.blocks_char_to_float_0, 0))    
        self.connect((self.tutorial_qpsk_demod_cpp_cb_0, 0), (self.digital_map_bb_0, 0))    
