...
# Generated: Tue Jun 20 12:38:40 2017
##################################################
...
class symbol_differential_filter_phases(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fractional_resampler_xx_0_2 = filter.fractional_resampler_ff(0*1.0/5, 1)
        self.fractional_resampler_xx_0_1_0 = filter.fractional_resampler_ff(4*1.0/5, 1)
        self.fractional_resampler_xx_0_1 = filter.fractional_resampler_ff(3*1.0/5, 1)
        self.fractional_resampler_xx_0_0 = filter.fractional_resampler_ff(2*1.0/5, 1)
        self.fractional_resampler_xx_0 = filter.fractional_resampler_ff(1*1.0/5, 1)
        ...
        self.connect((self.blocks_delay_0_0_0, 0), (self.qtgui_time_sink_x_0_0, 5))    
        self.connect((self.blocks_delay_0_0_1, 0), (self.qtgui_time_sink_x_0_0, 4))    
        self.connect((self.blocks_delay_0_0_2, 0), (self.qtgui_time_sink_x_0_0, 3))    
        self.connect((self.blocks_delay_0_0_3, 0), (self.qtgui_time_sink_x_0_0, 2))    
        self.connect((self.blocks_delay_0_0_4, 0), (self.qtgui_time_sink_x_0_0, 1))    
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.fractional_resampler_xx_0_1, 0))    
        self.connect((self.fir_filter_xxx_0, 0), (self.fractional_resampler_xx_0_1_0, 0))    
        self.connect((self.fir_filter_xxx_0, 0), (self.fractional_resampler_xx_0_2, 0))    
        ...
        self.connect((self.fractional_resampler_xx_0_1, 0), (self.fir_filter_xxx_0_2_0_1, 0))    
        self.connect((self.fractional_resampler_xx_0_1_0, 0), (self.fir_filter_xxx_0_2_0_1_0, 0))    
        self.connect((self.fractional_resampler_xx_0_2, 0), (self.fir_filter_xxx_0_2, 0))    
