...
# Title: Mpsk Stage2
# Generated: Tue Jun 20 11:30:21 2017
##################################################
...
class mpsk_stage2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Mpsk Stage2")
...
def main(top_block_cls=mpsk_stage2, options=None):
