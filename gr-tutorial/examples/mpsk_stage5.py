...
# Title: Mpsk Stage5
# Generated: Tue Jun 20 15:10:33 2017
##################################################
...
class mpsk_stage5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Mpsk Stage5")
...
def main(top_block_cls=mpsk_stage5, options=None):
